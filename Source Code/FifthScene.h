...
extern bool Button123Fif;

class FifthScene : public cocos2d::Layer
{
public:
	static cocos2d::Scene* createScene();
	virtual bool init();
	CREATE_FUNC(FifthScene);
	...
	void Npc3CallBack(Ref*pSender);
	void callFunc(Ref*pSender, TouchEventType type);
